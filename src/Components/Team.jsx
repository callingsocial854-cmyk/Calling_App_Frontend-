...
const Team = () => {
  ...
  const handleInputChange = (fieldKey, value) => {
    setFormData((prev) => {
      ...
      // 🔥 Reset all child fields depending on this parent
  ...
  if (serviceField) {
    ...
    if (
      ...
      const option = serviceField.options?.find(
        (opt) => opt.value === value,
      );
