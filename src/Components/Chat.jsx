...
const socket = io("ws://157.66.191.24:4446");

const Chat = () => {
  const senderId = "68ee25447f28937efa88967a";
  const receiverId = "68c2a7e04443d252c064ff7b";
  ...
  useEffect(() => {
    ...
    axios
      .get(
        `http://157.66.191.24:4446/api/chat/messages?senderId=${senderId}&receiverId=${receiverId}`
      )
